...
public class DubboProvider2 {
	private static final Log log = LogFactory.getLog(DubboProvider2.class);
	...
	public static void main(String[] args) {
		...
		try {
			...
			log.error("== DubboProvider2 context start error:", e);
		}

//		synchronized (DubboProvider2.class) {
//			while (true) {
//				try {
//					DubboProvider2.class.wait();
